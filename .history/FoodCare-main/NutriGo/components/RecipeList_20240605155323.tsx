...
// Naložite pisavo v aplikacijo
async function loadFonts() {
  await Font.loadAsync({
    'Popins-Regular': require('./assets/fonts/Popins-Regular.ttf'),
  });
}

// Preden zaženete aplikacijo, naložite pisave
loadFonts();
...
const localStyles = StyleSheet.create({
  ...
  recipeTitle: {
    fontFamily: 'Popins-Regular', // Uporaba prilagojene pisave Popins
    fontSize: 22,
    fontWeight: 'bold',
    color: '#333',
    marginBottom: 10,
