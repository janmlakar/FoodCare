 ...
 * It moves the /app directory to /app-example and creates a new /app directory with an app.tsx and _layout.tsx file.
...
export default function App() {
  return (
    ...
    >
      <Text>Edit app/app.tsx to edit this screen.</Text>
    </View>
  );
}
`;
